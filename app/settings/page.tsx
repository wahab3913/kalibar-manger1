...
import { ArrowLeft, Bell, Shield, Palette, Database, Key } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Get notified about route delays and issues</p>
                </div>
                <Switch defaultChecked />
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>System preferences and data management</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Allow data export to external formats</p>
                </div>
                <Switch defaultChecked />
              </div>
